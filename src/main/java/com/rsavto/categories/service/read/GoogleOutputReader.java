...
import com.rsavto.categories.docs.model.GoogleOutputRecord;
 ...
 * @author mfedechko
 */
public class GoogleOutputReader implements OutputReader {

    @Override
    public List<GoogleOutputRecord> readAllRecords(final String filePath) throws IOException {
        final var outputRecords = new ArrayList<GoogleOutputRecord>();
        ...
        while (rowIterator.hasNext()) {
            ...
            final var googleRecord = new GoogleOutputRecord();
            ...
            googleRecord.setPrice(new BigDecimal(price));
            ...
            outputRecords.add(googleRecord);
        }
